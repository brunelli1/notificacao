package com.raulproject.notificacao.business;

import com.raulproject.notificacao.business.dto.TarefasDTO;
import com.raulproject.notificacao.infraestructure.EmailExecption;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        ...
        try {
            ...
            throw new EmailExecption("Erro ao enviar o email ", e.getCause());
        }
    }
